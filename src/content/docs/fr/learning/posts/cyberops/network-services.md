---
title: Services réseau et analyse des protocoles pour Cisco CyberOps
description: Une analyse technique de haut niveau des protocoles de la couche transport (TCP/UDP), des services d'infrastructure (DNS, DHCP, NAT) et de la sécurité de la couche application (HTTP/HTTPS), conformément aux exigences de la certification Cisco CyberOps Associate.
order: 10
---
...
4. [File Transfer & Sharing Services](#4-file-transfer--sharing-services)
5. [Email Services](#5-email-services)
6. [HTTP & HTTPS](#6-http--https)
7. [Transport Protocols: TCP vs UDP](#7-transport-protocols-tcp-vs-udp)
8. [Wireshark — Protocol Analysis](#8-wireshark--protocol-analysis)
9. [Key Ports Reference](#9-key-ports-reference)
